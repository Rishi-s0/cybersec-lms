    ...
    <div className="max-w-md mx-auto htb-card rounded-lg p-8">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`htb-input w-full pl-10 pr-4 py-2 rounded-lg ${
                validationErrors.email ? 'border-htb-red' : ''
              }`}
              placeholder="Enter your email"
            />
          </div>
          {validationErrors.email && (
            <p className="mt-1 text-xs text-htb-red">{validationErrors.email}</p>
          )}
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <input
              ...
              onChange={handleChange}
              className="h-4 w-4 text-htb-green focus:ring-htb-green border-htb-gray/30 rounded bg-htb-dark-light"
            />
            <label htmlFor="remember-me" className="ml-2 block text-sm text-htb-gray">
              Remember me
            </label>
          </div>
          ...
          <div className="text-sm">
            <Link 
              to="/forgot-password" 
              className="text-htb-green hover:text-htb-green-light font-medium transition-colors"
            >
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-htb-dark text-htb-gray">Or continue with</span>
          </div>
        </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-htb-gray">
          ...
          <Link to="/register" className="text-htb-green hover:text-htb-green-light font-medium transition-colors">
            Sign up here
          </Link>
        </p>
      </div>
